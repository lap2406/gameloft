...
const Contact = () => {
    ...
    return (
        <Fragment>
            <div className="big-container mx-auto absolute w-full h-full left-0 right-0 z-20 pointer-events-none">
                <div className="absolute right-0 bottom-6 z-20 ">
                    <div className="relative mb-4 drop-shadow">
                        <span className="flex h-full w-full absolute top-0 z-0">
