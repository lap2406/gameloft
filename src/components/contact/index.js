...
const Contact = () => {
    ...
    return (
        <Fragment>
            <div className="fixed w-full h-full top-[80%] z-20 pointer-events-none overflow-hidden">
                <div className="big-container mx-auto flex px-3 sm:px-5 justify-end ">
                    <div className="p-2">
                        <div className="relative mb-4 drop-shadow ">
                            <span className="flex w-[33px] h-[33px] absolute top-0 z-0">
                                <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-gray-300 opacity-75"></span>
                                <span className="relative inline-flex rounded-full h-full w-full bg-gray-400"></span>
                            </span>
                            <div className="bg-white rounded-full p-2 relative w-[32.9px] h-[32.9px] flex items-center justify-center">
                                <svg id="Group_121" data-name="Group 121" xmlns="http://www.w3.org/2000/svg" width="14.362" height="14.875" viewBox="0 0 14.362 14.875">
                                    ...
                                    <path id="Path_206" data-name="Path 206" d="M1020.684,818.6l-7.779,4.4,7.779,4.4" transform="translate(-1009.958 -815.268)" fill="none" stroke="#2699fb" strokeLinejoin="round" strokeWidth="1" />
                                </svg>
                            </div>
                        </div>
                        <div className="relative mb-4 drop-shadow">
                            <div className="bg-white rounded-full p-2 relative w-[32.9px] h-[32.9px] flex items-center justify-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="17.12" height="13.04" viewBox="0 0 17.12 13.04">
