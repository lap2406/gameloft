            ...
            <div className="min-h-screen bg-white ">
                <div className="min-h-screen">
                    ...
                    <div className="all-post">
                        <div className="container mx-auto flex-wrap flex items-center justify-between mb-7">
                            ...
                            <div className="flex flex-wrap items-center justify-between">
                                ...
                                <div className="relative w-full sm:w-auto">
                                    <input type="text" placeholder="Search" className=" text-[15px] border px-3 border-[#2699FB] placeholder-[#2699FB] italic py-2 focus:outline-none focus-visible:shadow-blue-300 focus-visible:shadow  focus-visible:border-blue-300 hover:border-blue-300" />
